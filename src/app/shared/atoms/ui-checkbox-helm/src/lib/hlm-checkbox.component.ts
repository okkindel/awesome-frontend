...
import { IconName } from '@shared/atoms/ui-icon-helm/src';
...
export class HlmCheckboxComponent {
  ...
  public readonly checked = model<'indeterminate' | boolean>(false);
  ...
  // icon inputs
  public readonly checkIconName = input<IconName>('Check');
  ...
  // eslint-disable-next-line @typescript-eslint/no-empty-function,@typescript-eslint/no-unused-vars,,@typescript-eslint/no-explicit-any, @typescript-eslint/explicit-function-return-type
